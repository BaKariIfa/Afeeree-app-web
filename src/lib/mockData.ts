...
export const kataLinks = {
  kunindi: 'https://drive.google.com/file/d/1KmXAtqxPeYkKLJiTN4Z3t-f-X4QZQ2Kv/view?usp=drivesdk&disco=AAABy8JWcZA',
...
export const mockModules: Module[] = [
  ...
  },
  {
    ...
    pdfPage: 13,
    pdfLink: kataLinks.torsoDevelopment,
    localImage: danceClassImage,
    duration: '3 weeks',
    lessons: 6,
    completedLessons: 0,
  ...
  },
  {
    ...
    pdfPage: 16,
    pdfLink: kataLinks.traditionalSquats,
    localImage: danceClassImage,
    duration: '2 weeks',
    lessons: 5,
    completedLessons: 0,
  ...
  },
  {
    ...
    pdfPage: 5,
    pdfLink: kataLinks.sevenPrinciples,
    localImage: danceClassImage,
    duration: '4 weeks',
    lessons: 7,
    completedLessons: 0,
